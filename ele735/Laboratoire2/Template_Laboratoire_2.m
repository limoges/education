...
%%
% *L'amplitude du signal reçue par le capteur est de 0.26321*
%%
...
%%
% Distance entre la source 1 et le capteur: 5703.51.
%%
% Distance entre la source 1 et le capteur avec la réflexion au sol: 5755.87.
%%
% Distance entre la source 2 et le capteur: 5004.
%%
% Distance entre la source 2 et le capteur avec la réflexion au sol: 5063.6.
%%
...
function [amplitude_totale, distances] = calcule_somme_signaux_avec_reflexion(xy_capteur)
...
function partie3()
    ...
    fprintf('Partie 3\n');
    [amplitude_totale, distances] = calcule_somme_signaux_avec_reflexion(xy_capteur);
    fprintf('Distance entre la source 1 et le capteur: %g.\n', distances(1));
    fprintf('Distance entre la source 1 et le capteur avec la réflexion au sol: %g.\n', distances(2));
    fprintf('Distance entre la source 2 et le capteur: %g.\n', distances(3));
    fprintf('Distance entre la source 2 et le capteur avec la réflexion au sol: %g.\n', distances(4));
